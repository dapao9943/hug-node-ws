...
const UUID = process.env.UUID || '91d20397-b654-40a2-af7f-b68a93cf42d0'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'f21w8H1yWJfGzYTLbU';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
